...
public interface Constants {
  ...
  PyList<pyint> PARTICIPATION_FLAG_WEIGHTS = PyList.of(TIMELY_SOURCE_WEIGHT, TIMELY_TARGET_WEIGHT, TIMELY_HEAD_FLAG_INDEX);
  ...
  uint64 EPOCHS_PER_SYNC_COMMITTEE_PERIOD = new uint64(pow(pyint.create(2L), pyint.create(9L)));
  uint64 INACTIVITY_SCORE_BIAS = new uint64(pyint.create(4L));
  uint64 INACTIVITY_SCORE_RECOVERY_RATE = new uint64(pyint.create(16L));
