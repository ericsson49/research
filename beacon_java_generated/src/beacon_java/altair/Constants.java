...
public interface Constants {
  ...
  uint64 SYNC_COMMITTEE_SIZE = new uint64(pow(pyint.create(2L), pyint.create(10L)));
  uint64 SYNC_PUBKEYS_PER_AGGREGATE = new uint64(pow(pyint.create(2L), pyint.create(6L)));
  uint64 INACTIVITY_SCORE_BIAS = new uint64(pyint.create(4L));
  Epoch EPOCHS_PER_SYNC_COMMITTEE_PERIOD = new Epoch(pow(pyint.create(2L), pyint.create(8L)));
  ...
  uint64 MAX_VALID_LIGHT_CLIENT_UPDATES = new uint64(minus(pow(pyint.create(2L), pyint.create(64L)), pyint.create(1L)));
  Slot LIGHT_CLIENT_UPDATE_TIMEOUT = new Slot(pow(pyint.create(2L), pyint.create(13L)));
