...
val TIMELY_HEAD_FLAG_INDEX = pyint(0uL)
val TIMELY_SOURCE_FLAG_INDEX = pyint(1uL)
val TIMELY_TARGET_FLAG_INDEX = pyint(2uL)
val TIMELY_HEAD_WEIGHT = uint64(12uL)
val TIMELY_SOURCE_WEIGHT = uint64(12uL)
val TIMELY_TARGET_WEIGHT = uint64(24uL)
val SYNC_REWARD_WEIGHT = uint64(8uL)
...
val SYNC_COMMITTEE_SIZE = uint64(2uL.pow(10uL))
val SYNC_PUBKEYS_PER_AGGREGATE = uint64(2uL.pow(6uL))
val INACTIVITY_SCORE_BIAS = uint64(4uL)
val EPOCHS_PER_SYNC_COMMITTEE_PERIOD = Epoch(2uL.pow(8uL))
...
val ALTAIR_FORK_SLOT = Slot(18446744073709551615uL)
val TARGET_AGGREGATORS_PER_SYNC_SUBCOMMITTEE = 2uL.pow(2uL)
val SYNC_COMMITTEE_SUBNET_COUNT = 8uL
val MIN_SYNC_COMMITTEE_PARTICIPANTS = 1uL
val MAX_VALID_LIGHT_CLIENT_UPDATES = uint64(2uL.pow(64uL) - 1uL)
val LIGHT_CLIENT_UPDATE_TIMEOUT = Slot(2uL.pow(13uL))
