A very preliminary version of a project named "Onotole" - a python transpiler, intended to be usable with [beacon chain specs](https://github.com/ethereum/consensus-specs).
